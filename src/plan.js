    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          ex({
            ...
            restSec: { min: 60, max: 90 }, type: TYPES.MOBILITY_LOADED,
            video: { label: 'E3 Rehab: RDL', url: 'https://www.youtube.com/watch?v=uhghy9pFIPY', match: 'ähnlich', startSec: 82, endSec: 264,
              note: 'Video zeigt nur das Kapitel "So führst du RDLs richtig aus". Gleicher Hip-Hinge wie im RDL-Video, aber Knie deutlich gerader und Last leichter. Ziel ist kontrollierte Hamstring-Länge, nicht maximale Last.',
          ...
          ex({
            ...
            restSec: { min: 30, max: 60 }, type: TYPES.STRETCH_STATIC,
            video: { label: 'Dani Winks: Active Front Split Slides', url: 'https://www.youtube.com/watch?v=pNrx5WILVtw', match: 'passend', startSec: 46, endSec: 236,
              note: 'Video zeigt nur den ersten Drill ("Half Split Forward Fold Slides" mit Stuhl/Blocks) - passt am besten zum Plan-Hold mit Stütze. Für den statischen Plan-Hold darfst du Blocks/Stütze nutzen und 30-60s kontrolliert halten.',
      ...
      },
      {
        ...
        exercises: [
          ...
          ex({
            ...
            restSec: { min: 30, max: 60 }, type: TYPES.STRETCH_STATIC,
            video: { label: 'Video-Suche: Dani Winks Pancake Stretch', url: 'https://www.youtube.com/results?search_query=Dani+Winks+pancake+stretch', match: 'ähnlich',
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          ex({
            id: 'mi-hang', name: 'Passive Hang -> Active Hang (Handtuch-Griff)', dosage: '2 x 20-30 s + 5 reps', sets: 2, holdSec: { min: 20, max: 30 }, reps: { min: 5, max: 5 },
            restSec: { min: 60, max: 60 }, type: TYPES.MOBILITY_ACTIVE,
            video: { label: 'How to Perform a Towel Dead Hang', url: 'https://www.youtube.com/watch?v=UpP-77-GeLA', match: 'passend',
              note: 'Handtuch um die Klimmzugstange wickeln, an beiden Enden greifen - erhöht die Griffanforderung deutlich. Erwarte kürzere Haltezeiten als am blanken Griff, das ist normal. Danach wie bisher ohne Ellbogenbeugung nur die Schulterblätter aktiv bewegen.',
              cues: 'Arme lang; Scapula bewegt; Rumpf ruhig; Griff aktiv zudrücken, nicht nur halten.' },
          }),
        ],
      },
    ],
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          ex({
            id: 'sa-rotpower', name: 'Cable Rotational Throw', dosage: '3 x 5 / Seite', sets: 3, reps: { min: 5, max: 5 }, perSide: true,
            restSec: { min: 120, max: 240 }, type: TYPES.POWER, warmup: 'power',
            video: { label: 'Cable Rotational Punch: Explosive Rotation & Force Transfer', url: 'https://www.youtube.com/watch?v=R-yu0RjMW-k', match: 'passend',
              note: 'Explosiver Zug aus Hüfte/Rotation gegen den Kabelzug, kontrollierte Rückführung. Volle Erholung zwischen den Wiederholungen - Qualität/Explosivität vor Tempo-Serie.',
              cues: 'Aus der Hüfte starten; Kraft durch den Rumpf übertragen; Arm folgt nur der Rotation.' },
          }),
          ex({
          ...
          ex({
            id: 'sa-finisher', name: 'Runden-Conditioning', dosage: '3 x 3 min Arbeit / 1 min Pause', type: TYPES.FINISHER,
            durationSec: { min: 600, max: 660 }, restSec: { min: 60, max: 60 },
            note: 'Zirkel aus bereits bekannten, sauberen Übungen (z.B. Ring Push-up, Ring Row, KH-Squat) im 3:1-Verhältnis - spiegelt die Runden-Struktur von Boxen/MMA. Keine neuen Technikregeln. Runde abbrechen oder Tempo/Reps reduzieren, bevor Technik deutlich zerfällt.',
            video: null,
          }),
        ],
      },
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          ex({
            ...
            restSec: { min: 30, max: 60 }, type: TYPES.STRETCH_STATIC,
            video: { label: 'Video-Suche: Dani Winks Middle Split', url: 'https://www.youtube.com/results?search_query=Dani+Winks+middle+split+flexibility', match: 'ähnlich',
...
const EXERCISE_ICONS = {
  ...
  'sa-neck': 'rotate', 'sa-pogo': 'jump', 'sa-rotpower': 'rotate', 'sa-explosivepullup': 'pull', 'sa-revlunge': 'squat',
